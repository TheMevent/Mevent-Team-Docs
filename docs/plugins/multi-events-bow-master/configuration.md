---
title: "Конфигурация"
description: "Полный справочник по параметрам конфигурации плагина Bow Master."
sidebar_position: 4
---

# Конфигурация

Файл конфигурации расположен по пути: `oxide/config/MultiEventsBowMaster.json`
...
:::tip Совет
Добавьте несколько мест в рейтинге (1, 2, 3) с разными наградами, чтобы мотивировать больше игроков участвовать в ивенте.
:::
