---
title: "Configuration -- Mushroom Madness"
description: "Detailed description of all configuration parameters for the Mushroom Madness mode."
sidebar_position: 4
---

# Mushroom Madness Configuration
