---
title: "Configuration — Npc Underwater Lab"
description: "Detailed description of all configuration options for the Npc Underwater Lab mode."
sidebar_position: 4
---

# Npc Underwater Lab Configuration
