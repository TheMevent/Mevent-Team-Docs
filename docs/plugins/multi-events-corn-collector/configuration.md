---
title: "Конфигурация"
description: "Полный справочник по параметрам конфигурации плагина Corn Collector."
sidebar_position: 4
---

# Конфигурация

Файл конфигурации расположен по пути: `oxide/config/MultiEventsCornCollector.json`
...
:::tip Совет
Увеличьте длительность ивента, если на вашей карте мало кукурузы, чтобы дать игрокам больше времени на сбор.
:::
