---
title: "Setup -- Looking Loot"
description: "Installation guide for the Looking Loot mode for Multi Events"
sidebar_position: 2
---
...
Set up the item value table and default point multiplier. See [Configuration](./configuration) for details.

### Step 4. Test It

Run `lookingloot.start` in the server console to manually start the event and verify everything works.
